...
<div class="container" style="max-width: 900px; margin: 40px auto; text-align: center;">
    <div style="background-color: #fff3cd; color: #856404; padding: 20px; border-radius: 8px;">
        <h1 style="font-size: 2rem; font-weight: 700; margin-bottom: 16px;">Menunggu Pembayaran</h1>
        <p style="font-size: 1.2rem; margin-bottom: 8px;">Silakan selesaikan pembayaran Anda.</p>
        @if(isset($orderId))
