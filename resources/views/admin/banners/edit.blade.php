...
<div class="card">
    <div class="card-header">
        <h5 style="margin: 0;">Form Edit Banner</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="current-image">
                    ...
                    <img src="{{ asset('storage/banners/' . $banner->image) }}" 
                         alt="{{ $banner->alt_text }}"
                         style="max-width: 250px; border-radius: 6px; border: 1px solid #ddd;">
                    @else
            ...
            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                <label for="image">Ganti Gambar Banner</label>
                <input type="file" id="image" name="image" accept="image/*">
                <span class="form-text">Format: JPG, JPEG, PNG, GIF. Maksimal 5MB. Biarkan kosong jika tidak ingin mengubah</span>
                @error('image')
            ...
            <div class="form-group">
                ...
                <input type="text" id="alt_text" name="alt_text" value="{{ $banner->alt_text ?? '' }}" 
                       placeholder="Contoh: Banner Koleksi Gelang">
                @error('alt_text')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" id="link" name="link" value="{{ $banner->link ?? '' }}" 
